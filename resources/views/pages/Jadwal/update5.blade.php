													...
													<form class="form-horizontal">
														<fieldset>
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('senin') is-invalid @enderror" id="senin" name="senin">
																		...
																		@foreach ($jadwaledit5 as $rowsenin)
																		<option value="{{ $rowsenin->nama_matapelajaran }}" {{ $murid5->senin == $rowsenin->nama_matapelajaran ? 'selected' : '' }}>{{ $rowsenin->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('senin')
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('selasa') is-invalid @enderror" id="selasa" name="selasa">
																		<option value="" disabled selected>Pilih Pelajaran</option>
																		@foreach ($jadwaledit5 as $rowselasa)
																		<option value="{{ $rowselasa->nama_matapelajaran }}" {{ $murid5->selasa == $rowselasa->nama_matapelajaran ? 'selected' : '' }}>{{ $rowselasa->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('selasa')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('rabu') is-invalid @enderror" id="rabu" name="rabu">
																		<option value="" disabled selected>Pilih Pelajaran</option>
																		@foreach ($jadwaledit5 as $rowrabu)
																		<option value="{{ $rowrabu->nama_matapelajaran }}" {{ $murid5->rabu == $rowrabu->nama_matapelajaran ? 'selected' : '' }}>{{ $rowrabu->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('rabu')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('kamis') is-invalid @enderror" id="kamis" name="kamis">
																		<option value="" disabled selected>Pilih Pelajaran</option>
																		@foreach ($jadwaledit5 as $rowkamis)
																		<option value="{{ $rowkamis->nama_matapelajaran }}" {{ $murid5->kamis == $rowkamis->nama_matapelajaran ? 'selected' : '' }}>{{ $rowkamis->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('kamis')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('jumat') is-invalid @enderror" id="jumat" name="jumat">
																		<option value="" disabled selected>Pilih Pelajaran</option>
																		@foreach ($jadwaledit5 as $rowjumat)
																		<option value="{{ $rowjumat->nama_matapelajaran }}" {{ $murid5->jumat == $rowjumat->nama_matapelajaran ? 'selected' : '' }}>{{ $rowjumat->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('jumat')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<select class="form-control @error('sabtu') is-invalid @enderror" id="sabtu" name="sabtu">
																		<option value="" disabled selected>Pilih Pelajaran</option>
																		@foreach ($jadwaledit5 as $rowsabtu)
																		<option value="{{ $rowsabtu->nama_matapelajaran }}" {{ $murid5->sabtu == $rowsabtu->nama_matapelajaran ? 'selected' : '' }}>{{ $rowsabtu->nama_matapelajaran }}</option>
																		@endforeach
																	</select>
																	@error('sabtu')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="time" name="waktu_pelajaran" id="waktu_pelajaran" class="form-control" placeholder="Masukkan Waktu" value="{{ $murid5->waktu_pelajaran }}">
