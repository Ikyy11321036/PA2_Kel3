	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Silabus PPKN</div>
				</div>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="card card-box">
										...
										@foreach($ppknsilabus as $rowppkn)
										<table>
												<tbody>
													<tr>
														<td>
														...
														<td>															
															<a href="{{ route('editsilabusppkn', $rowppkn->id) }}" class="tblEditBtn">
																<i class="fa fa-pencil"></i>
															</a>
															<a href="#" class="tblDelBtn delete" data-id="{{ $rowppkn->id }}">
...
<script>
	$('.delete').click(function() {
		var silabusppknid = $(this).attr('data-id');
		swal({
			...
			.then((willDelete) => {
				if (willDelete) {
					window.location = "/deletesilabusppkn/" + silabusppknid;
