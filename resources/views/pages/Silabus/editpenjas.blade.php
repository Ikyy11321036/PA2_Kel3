													...
													<form class="form-horizontal">
														...
														<legend>Masukkan Data</legend>
                                                            <div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="nama_materi" id="nama_materi" class="form-control @error('nama_materi') is-invalid @enderror" placeholder="Masukkan Judul Silabus" value="{{ $penjass->nama_materi }}">
																	@error('nama_materi')
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="silabus" id="silabus" class="form-control @error('silabus') is-invalid @enderror" placeholder="Masukkan Informasi" value="{{ $penjass->silabus }}">
																	@error('silabus')
																	<div class="alert alert-danger my-3 col-sm-6" role="alert">
																		{{ $message }}
																	</div>
