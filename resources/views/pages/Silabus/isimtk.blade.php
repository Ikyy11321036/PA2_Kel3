	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Silabus Matematika</div>
				</div>
									...
									<div class="card card-box">
										...
										<table>
												<tbody>
													<tr>
														<td>
															<h4>Download Silabus: <a href="{{ asset('filesilabus/'.$rowmtk->file) }}"> {{ $rowmtk->nama_materi }} </a></h4>
															<h5>Mengenai Silabus: {{ $rowmtk->silabus }}</h5>
														</td>
														@auth
														@if(Auth::user()->role == 'admin')
														<td>															
