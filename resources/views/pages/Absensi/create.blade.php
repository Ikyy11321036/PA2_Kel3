		...
		<div class="row">
			<div class="col-md-12">
				<div class="tabbable-line">
					...
					<form action="{{ route('insertabsen') }}" method="post" enctype="multipart/form-data">
						@csrf
													...
													<form class="form-horizontal">
														<fieldset>
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="text" name="username" id="username" class="form-control" placeholder="Masukkan nama" value="{{ old('username') }}" required />
																</div>
															</div>
                                                            <div class="form-group">
...
<script>
	$(document).ready(function() {
		$('form').submit(function(e) {
			...
			swal({
				title: "Berhasil",
				text: "Nama Siswa Berhasil Ditambah!",
				icon: "success",
			}).then(function() {
				form.submit();
			});
