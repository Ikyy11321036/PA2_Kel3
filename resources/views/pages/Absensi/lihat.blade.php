	...
	<div class="page-content">
		<div class="page-bar">
			<div class="page-title-breadcrumb">
				<div class=" pull-left">
					<div class="page-title">Keterangan Murid</div>
				</div>
				<ol class="breadcrumb page-breadcrumb pull-right">
					...
					<li class="active">Keterangan Murid</li>
				</ol>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
				<div class="tabbable-line">
					...
					<form action="{{ route('insertketerangan') }}" method="post" enctype="multipart/form-data">
						@csrf
													...
													<form class="form-horizontal">
														<fieldset>
															...
															<div class="form-group">
																<label class="control-label col-sm-2" for="keterangan">Keterangan Murid</label>
																<div class="col-sm-6">
																	<input type="text" name="keterangan" id="keterangan" class="form-control" placeholder="Masukkan nama" value="{{ old('keterangan') }}">
																</div>
															</div>
                                                            <div class="form-group">
																<label class="control-label col-sm-2" for="absensi">Absensi Siswa</label>
																<div class="col-sm-6">
																	<select class="form-select" name="absensi" id="absensi" value="{{ old('absensi') }}" aria-label="Default select example">
                                                            ...
                                                            <div class="form-group">
																...
																<div class="col-sm-6">
																	<input type="date" name="tgl" id="tgl" class="form-control" placeholder="Masukkan Tanggal" value="{{ old('tgl') }}">
																</div>
															</div>
                                                            <div class="form-group">
